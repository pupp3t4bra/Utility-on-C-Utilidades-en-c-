#include <stdio.h>
/*En este programa calcularemos el consumo de gasolina de un coche*/

int main (void){
    float litros,dinero,kilometros,precio,consumo;
    char repetir;
...
/*Pedimos los datos al usuario*/
    ...
    scanf("%f",&kilometros);
    printf("Escribe cuanto le pusistes al vehiculo:");
    scanf("%f",&dinero);

/*Primero hay que saber cuantos litros entran con el dinero que ponemos*/
